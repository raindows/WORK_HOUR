	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
				...
				sb.append("	<li><a id='prevPage_link'>上页</a></li>\n");
			}else{
				sb.append("	<li><a>共<font color=red>"+totalResult+"</font>条</a></li>\n");
				sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"width:50px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"toTZ();\"  class=\"btn btn-mini btn-success\">跳转</a></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a onclick=\"nextPage(1)\">首页</a></li>\n");
				sb.append("	<li style=\"cursor:pointer;\"><a id='prevPage_link' onclick=\"nextPage("+(currentPage-1)+")\">上页</a></li>\n");
			}
			...
			if(currentPage==totalPage){
				sb.append("	<li><a id='nextPage_link'>下页</a></li>\n");
				sb.append("	<li><a>尾页</a></li>\n");
			}else{
				sb.append("	<li style=\"cursor:pointer;\"><a id='nextPage_link' onclick=\"nextPage("+(currentPage+1)+")\">下页</a></li>\n");
			...
			sb.append("	<option value='99'>100</option>\n");
			sb.append("	</select>\n");
			sb.append("	</li>\n");
