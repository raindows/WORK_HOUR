...
<body class="easyui-layout" style="padding: 2px;">
	<table id="dg" class="easyui-datagrid" style="height:100%;display: none" 
		...
		url="task/loadMyTask"
		rownumbers="true"
		title="我的任务" toolbar="#tb" pagination="true">
	...
	<thead>
		<tr>
			...
			<th field="REAL_COMPLETE_TIME" align="center" width="1" hidden='true' >实际完成时间</th>
			<th field="TASK_CLOSE_TIME" align="center" width="1"  hidden='true'>任务关闭时间</th>
			<th field="TASK_STATE" align="center" width="100px" data-options="formatter:formatTASK_STATE">任务状态</th>	
			<th field="PERSON_LIABLE" align="center" width="80px">责任人</th>
		</tr>
	</thead>
</table>
<div id="tb" style="display:none">
	<a href="javascript:;" id="okBtn"class="easyui-linkbutton" iconCls="icon-ok" plain="true">完成</a>
	...
	$(function(){
	   ...
	   $("#addBtn").on("click",function(){
		...
		$("#okBtn").on("click",function(){
			...
			$.messager.confirm('', '确认提交当前选择的任务？', function(r){
				if (r){
					$.messager.progress({title:"",msg:"正在处理,请稍后",text:"",interval:500});
					//提交服务器删除
					$.ajax({
						type: "POST",
						url: "task/task_submitTask",
						dataType:'json',
						data:row,
						cache: false,
